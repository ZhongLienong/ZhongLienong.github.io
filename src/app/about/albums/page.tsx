...
const LazySpotifyPlayer = dynamic(
  () => import('./LazySpotifyPlayer'),
  { ssr: false }
)
...
export default function Albums() {
  ...
  useEffect(() => {
    const loadAlbums = async () => {
      try {
        // Import the albums data with type assertion
        const { default: albumsData } = await import('./albums.json') as { default: Album[] }
